...
/*   Updated: 2016/12/15 17:12:42 by jgeslin          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void				ft_lstpushback(t_list **alst, void const *content,
					size_t content_size);
void				ft_ldstassback(t_ldst **alst, void *content,
					size_t content_size);
void				ft_ldstassend(t_ldst **alst, void *content, size_t content_size);
void				ft_ldstpushback(t_ldst **alst, void const *content,
					size_t content_size);
void				ft_lstpushend(t_list **alst, void const *content,
					size_t content_size);
void				ft_ldstpushend(t_ldst **alst, void const *content,
					size_t content_size);
...
char				*ft_sfprintf(char *f, const char *format, ...);
