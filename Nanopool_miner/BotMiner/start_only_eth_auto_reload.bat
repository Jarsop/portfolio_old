...
set arguments= " --farm-recheck 200 -epool eth-eu1.nanopool.org:9999 -ewal 0xce478277c69fb38d76760ae3a555c23afa1311a1  -U --gpu-batch-size 18 --gpu-mining-buffers 2 --gpu-workgroup-size 128 -epsw Shadow -etht 1000 -mode 1 -ftime 10
pause"
set duree_redem=1
